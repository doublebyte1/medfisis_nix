...
**
** Created: Fri Sep 2 11:00:42 2011
...
public:
    ...
    void setupUi(QWidget *frmframe)
    {
        ...
        frmframe->resize(770, 479);
        verticalLayout = new QVBoxLayout(frmframe);
        ...
        verticalLayout->addWidget(groupPhysical);
        ...
        verticalLayout->addWidget(groupBackNext);
